...
import { HoardingNudge } from './components/HoardingNudge';

function App() {
  const {
    todos, isLoading, error, shouldCelebrate, isOverloaded,
    dismissCelebration, getOpacity, addTodo, completeTodo, deleteTodo,
  } = useTodos();
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-4">
          ...
          <HoardingNudge active={isOverloaded} />
